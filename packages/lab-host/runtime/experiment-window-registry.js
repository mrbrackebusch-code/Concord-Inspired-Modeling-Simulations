(function() {
  var experiments = [
    ...
    },
    {
      ...
      suite: "Mass & Change",
      renderMode: "custom",
      customStageId: "unit-01/lesson-01/mass-change/ice-to-water",
      customStageScript: "/packages/lab-host/runtime/custom-stages/ice-to-water-stage.js",
    ...
    },
    {
      ...
      suite: "Mass & Change",
      renderMode: "custom",
      customStageId: "unit-01/lesson-01/mass-change/precipitate",
      customStageScript: "/packages/lab-host/runtime/custom-stages/precipitate-stage.js",
      ...
      briefing: "Weigh the paired clear solutions, pour one into the other, and watch the milky white precipitate bloom where the liquids first meet before the setup returns to the tray for the final mass.",
      objectTray: ["Two glass test tubes", "Clear solutions", "Balance tray"],
      procedure: [
        "Place both solution tubes on the tray",
        "Record the initial mass",
        "Pour one tube into the other",
        "Wait for the new solid to form",
        "Record the final mass"
      ],
      sharedVerbs: ["press Weigh", "press Pour", "observe the clouding", "Reset"],
